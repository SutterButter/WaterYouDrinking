...
class PurityMapViewController: UIViewController, CLLocationManagerDelegate {
    ...
    override func loadView() {
        ...
        ref.child("waterPurityReports").observeSingleEvent(of: .value, with: { snapshot in
            ...
            while let rest = enumerator.nextObject() {
                ...
                let virus = (rest as! FIRDataSnapshot).childSnapshot(forPath: "virusPPM").value as! Int
                let cont = (rest as! FIRDataSnapshot).childSnapshot(forPath: "contaminantPPM").value as! Int
                ...
                marker.snippet = "Condition" + ": " + cond + ",\n Virus PPM: " + String(virus) + ",\n Contaminant PPM: " + String(cont)
